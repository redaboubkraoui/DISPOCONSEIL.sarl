 <footer class="footer-standard-dark bg-extra-dark-gray">
                ...
                <div class="row equalize xs-equalize-auto">
                    <div class="col-md-3 col-sm-6 col-xs-12 widget border-right border-color-medium-dark-gray sm-no-border-right sm-margin-30px-bottom xs-text-center">
                        ...
                        <div class="social-icon-style-8 display-inline-block vertical-align-middle">
                            <ul class="small-icon no-margin-bottom">
                                ...
                                <li>
                                    <a class="instagram text-white" href="https://www.instagram.com/oubratra_maroc/" target="_blank">
                                        <i class="fab fa-instagram"></i></a>
                                </li>
                                <li>
                                    <a class="whatsapp text-white" href="https://wa.me/212661091785" target="_blank">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 widget border-right border-color-medium-dark-gray padding-45px-left sm-padding-15px-left sm-no-border-right sm-margin-30px-bottom xs-text-center">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li> <a class="" href="qui-sommes-nous.html">QUI SOMMES-NOUS</a>
                            </li>
                            <li>
        ...
        <div class="bg-dark-footer padding-50px-tb text-center xs-padding-30px-tb">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12 text-left text-small xs-text-center">&copy; Copyright Oubratra.ma 2019</div>
                </div>
            </div>
        </div>
    </footer> <a class="scroll-top-arrow" href="javascript:void(0);"><i class="ti-arrow-up"></i></a>
    <script type="text/javascript" src="https://www.oubratra.ma/js/jquery.js"></script>
    <script type="text/javascript" src="https://www.oubratra.ma/js/app.min.js"></script>
    <script>
        $('.locate').click(function() {
            var position = $(this).attr('rel');
            $('.bloc-location').hide();
            $('.location-' + position).show();
        });
    </script>
</body>
